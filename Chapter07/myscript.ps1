...
#Constant Variables
$OutputFile = "Groups.csv"   #The CSV Output file that is created, change for your purposes
$arrDLMembers = @{}
...
$objDistributionGroups = Get-UnifiedGroup --ResultSize Unlimited
...
Foreach ($objDistributionGroup in $objDistributionGroups)
{
    ...
    $objDGMembers = Get-DistributionGroupMember -Identity "North Portal Readers"
